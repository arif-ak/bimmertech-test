...
class BlogReviewRepository extends EntityRepository
{
    public function pagination($productId, $page = null)
    {
        ...
        return $this->createQueryBuilder('o')
            ...
            ->setParameter('status', BlogReview::STATUS_ACCEPTED)
    ...
    public function starRatingByBlog($id)
    {
        $class = BlogReview::class;
