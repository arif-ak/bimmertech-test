...
class ProductInstallersType extends AbstractType
{
    protected $uploader;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('images', CollectionType::class, [
                'entry_type' => ProductInstallersImageType::class,
                ...
                /** @var ProductInstallersImageType $image */
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => ProductInstaller::class,
        ]);
    }
