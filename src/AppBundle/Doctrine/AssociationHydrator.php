...
final class AssociationHydrator
{
    ...
    {
        foreach ($associationsPaths as $associationPath => $parameters) {

            if (is_string($parameters)) {
                $associationPath = $parameters;
                $parameters = [];
            }

            $this->hydrateAssociation($subjects, $associationPath, $parameters);
        }
    }
     ...
     */
    public function hydrateAssociation($subjects, string $associationPath, $parameters = []): void
    {
        ...
        foreach ($parameters as $associationColumn => $value) {
            $query = $query->andWhere("associations.$associationColumn = '$value'");
        }
